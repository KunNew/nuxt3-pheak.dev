...
<template>
  <button type="button" class="relative group hidden lg:flex">
    <div class="inline-flex">
      ...
      <ul
        class="scale-0 group-hover:scale-100 transition-all duration-300 ease-in-out absolute z-50 bottom-full sm:bottom-auto right-0 sm:top-6 sm:-right-10 w-36 cursor-pointer rounded-lg p-2 bg-white dark:bg-slate-800 border dark:border-white/10 sm:shadow-lg backdrop-blur-md"
      >
        <li
